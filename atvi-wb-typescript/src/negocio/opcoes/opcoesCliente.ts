        ...
        while(this.execucao){
            ...
            switch(opcao){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    let nomeClienteView = this.entrada.receberTexto(`Por favor informe o nome do cliente: `);
                    let clienteView = this.empresa.getClientes.find(client => client.nome == nomeClienteView);7
                    ...
                    break;
                case 5:
                    let nomeClienteDelete = this.entrada.receberTexto(`Por favor informe o nome do cliente: `);
                    let clienteDelete = this.empresa.getClientes.find(client => client.nome == nomeClienteDelete);
